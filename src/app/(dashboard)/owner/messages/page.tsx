      ...
      <div className="flex h-full">
                ...
                filteredConversations.map((conv: any) => (
                  ...
                  >
                    ...
                    <div className="flex-1 text-left overflow-hidden">
                      ...
                      <p
                        className={`text-[11px] font-bold leading-snug truncate ${conv.unread_count > 0 ? "text-slate-900" : "text-slate-400"}`}
                      >
        ...
        {activeContact ? (
          <div className="flex-1 flex flex-col bg-white">
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <div className="flex items-center gap-2 mt-1">
                    <Badge
                      variant="outline"
                      className="text-[9px] font-black uppercase tracking-widest px-2 py-0 h-5 bg-slate-50 border-none text-slate-400"
                    >
                      {activeContact.type === "VET"
                        ? "Professional Veterinarian"
                        : "Verified Shop Support"}
                    </Badge>
                  </div>
                </div>
              </div>
            ...
            <form
              onSubmit={handleSend}
              className="p-8 border-t border-slate-50 bg-white shrink-0"
            >
              <div className="max-w-4xl mx-auto flex items-center gap-4">
                <div className="flex gap-2 hidden sm:flex">
                  <Button
                    ...
                    variant="ghost"
                    size="icon"
                    className="h-14 w-14 rounded-2xl bg-slate-50 text-slate-400 hover:text-blue-600"
                  >
