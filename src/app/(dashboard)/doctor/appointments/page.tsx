  ...
  return (
    <div className="flex flex-col gap-8 p-4 md:p-8 bg-[#f8fafc] min-h-screen">
      <header className="flex flex-col gap-2">
        <h1 className="text-5xl font-[900] uppercase tracking-tighter text-slate-900">
          Records
        </h1>
      ...
      <div className="bg-white rounded-[2rem] shadow-xl overflow-hidden">
        <Table>
          <TableHeader className="bg-slate-50/50">
            <TableRow>
              <TableHead className="px-8 py-6 text-[10px] font-black uppercase text-slate-400">
                Patient
              </TableHead>
              ...
              filteredData.map((apt) => (
                <TableRow key={apt.id} className="hover:bg-slate-50/50">
                  ...
                  <TableCell>
                    ...
                    <div className="text-[9px] font-black text-blue-600 uppercase mt-1">
                      {apt.time}
                    </div>
                  </TableCell>
                  <TableCell>
