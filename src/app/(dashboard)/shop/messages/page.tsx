...
import { mockChatHistory, shopConversations } from "@/utils/message";
...
export default function ShopMessagesPage() {
  ...
  const activeChat =
    shopConversations.find((c) => c.id === activeId) || shopConversations[0];
    ...
    <div className="flex flex-col h-[calc(100vh-10rem)] bg-white border-none shadow-2xl shadow-slate-200/50 rounded-[2.5rem] overflow-hidden">
      <div className="flex h-full">
                ...
                >
                  ...
                  <div className="flex-1 text-left overflow-hidden">
                    <div className="flex justify-between items-center mb-1">
                      <span className="font-black text-slate-900 uppercase tracking-tight text-xs truncate">
                        {conv.name}
                      </span>
                    ...
                    <p
                      className={`text-[11px] font-bold leading-snug truncate ${conv.unread > 0 ? "text-slate-900" : "text-slate-400"}`}
                    >
                      {conv.lastMessage}
                    </p>
                  </div>
        ...
        <div className="flex-1 flex flex-col bg-white">
          <div className="h-24 flex items-center justify-between px-8 border-b border-slate-50">
            ...
            <div className="flex items-center gap-3">
              <Button
                variant="outline"
                className="h-12 px-6 rounded-2xl border-2 border-emerald-50 text-emerald-600 font-black uppercase text-[10px] tracking-widest hover:bg-emerald-50 transition-all"
              >
              ...
              <Button
                variant="ghost"
                size="icon"
                className="h-12 w-12 rounded-2xl text-slate-200"
              >
            ...
            <div className="max-w-4xl mx-auto flex items-center gap-4">
              <div className="flex gap-2">
                <Button
                  variant="ghost"
                  size="icon"
                  className="h-14 w-14 rounded-2xl bg-slate-50 text-slate-400 hover:text-emerald-600"
                >
        ...
        <div className="hidden xl:flex w-[300px] border-l border-slate-50 p-8 flex-col gap-8 bg-white">
          <div>
            <h4 className="text-[10px] font-black uppercase tracking-[0.2em] text-slate-300 mb-6">
              Customer Profile
            </h4>
            <div className="space-y-6">
              ...
              <div className="flex items-center gap-4">
                ...
                <Badge className="bg-emerald-50 text-emerald-600 border-none font-black text-[8px] uppercase tracking-widest px-3">
                  Top Tier
                </Badge>
              </div>
            </div>
          ...
          <div>
            ...
            <div className="space-y-1">
              <Button
                variant="ghost"
                className="w-full justify-between font-black text-[10px] uppercase tracking-widest text-slate-400 hover:text-emerald-600 px-0 group"
              >
                Refund Policy{" "}
                <ExternalLink
                  size={12}
          ...
          <div className="mt-auto p-6 bg-slate-950 rounded-[2rem] text-white relative overflow-hidden group">
            ...
            <p className="text-xs font-medium leading-relaxed text-slate-400">
              Messages are monitored for quality control.
            </p>
          </div>
        </div>
      </div>
