...
export default function ShopOrdersPage() {
  ...
  const getStatusBadge = (status: string) => {
    ...
    return (
      <Badge
        className={`${variants[status]} border-none font-black text-[9px] uppercase tracking-widest px-3 py-1`}
      >
        {labels[status]}
      </Badge>
    );
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
        <div className="space-y-2">
          ...
          <p className="text-slate-500 font-medium text-sm flex items-center gap-2">
            <Activity className="h-4 w-4 text-emerald-600" /> Managing demand
            for {user?.full_name}.
          </p>
        </div>
      </div>
                  ...
                  {filteredOrders.length === 0 ? (
                    ...
                    filteredOrders.map((order) => (
                      ...
                      >
                        ...
                        <TableCell>
                          <div className="text-[10px] font-bold text-slate-600 line-clamp-1 max-w-[180px]">
                            {order.items_summary}
                          </div>
                        </TableCell>
                        <TableCell>
                          <div className="text-sm font-[900] text-slate-900 tracking-tighter">
                            ₹{order.total_amount}
                          </div>
                          <div className="text-[8px] font-black text-emerald-600 uppercase tracking-[0.2em]">
                        ...
                        <TableCell className="text-right py-6 px-8">
                          <DropdownMenu>
                            ...
                            >
                              ...
                              <DropdownMenuItem className="rounded-xl font-bold text-sm py-3 px-4 focus:bg-slate-50">
                                <ExternalLink className="mr-3 h-4 w-4" /> Order
                                Details
                              </DropdownMenuItem>
