...
export default function EventsPage() {
  ...
  const handleFeatureDev = (featureName: string) => {
    toast.info("Feature Under Development", {
      description: `${featureName} will be available in the next update. Stay tuned!`,
          ...
          <div className="max-w-7xl mx-auto relative z-10 flex flex-col md:flex-row justify-between items-center gap-12">
            <div className="space-y-6 text-center md:text-left">
              ...
              <p className="text-orange-100 max-w-lg text-lg">
                Join verified community events organized by Poshik Super Admins
                to connect with other pet lovers.
              </p>
            </div>
            <div className="bg-white/10 backdrop-blur-xl p-8 rounded-[3rem] border border-white/20 w-full md:w-96 text-center">
              ...
              <Button
                onClick={() => handleFeatureDev("Early Access")}
                className="mt-6 w-full bg-white text-orange-600 hover:bg-orange-50 font-black h-12 rounded-2xl"
              >
                Get Early Access
              </Button>
            </div>
          ...
          {isLoading ? (
            ...
            <>
              ...
              <div className="mt-20 text-center">
                <Button
                  variant="outline"
                  className="rounded-2xl h-14 px-12 border-2 border-slate-100 font-bold hover:bg-slate-50 transition-all text-slate-600"
                >
        ...
        <section className="py-24 bg-slate-50 border-t border-slate-100">
          <div className="max-w-4xl mx-auto px-6 text-center space-y-8">
            ...
            <p className="text-slate-500 text-lg leading-relaxed max-w-xl mx-auto">
              Admins and verified partners can host and promote events directly
              on the Poshik platform. Apply for Event Admin status today.
            </p>
            <Button
              onClick={() => handleFeatureDev("Host Applications")}
              className="bg-slate-900 hover:bg-orange-600 text-white rounded-2xl h-14 px-10 font-bold shadow-xl transition-all"
            >
      ...
      <div className="p-8 space-y-4">
        ...
        <div className="pt-4 flex items-center justify-between border-t border-slate-50">
          ...
          <Button
            ...
            className="text-orange-600 font-bold p-0 flex items-center gap-1 group/btn"
          >
            Join Event{" "}
