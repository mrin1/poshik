...
import { sidebarLinks } from "@/utils/admin";
...
export default function Sidebar() {
  ...
  return (
    <>
      ...
      <aside
        className={`w-80 bg-white border-r border-slate-100 flex flex-col h-[calc(100vh-5rem)] fixed lg:sticky top-0 lg:top-20 z-50 lg:z-0 overflow-hidden transition-transform duration-300 ease-in-out ${isSidebarOpen ? "translate-x-0" : "-translate-x-full lg:translate-x-0"}`}
      >
        ...
        <nav className="flex-1 px-6 py-8 space-y-2 overflow-y-auto no-scrollbar">
          ...
          <div className="mt-12 p-6 rounded-[2rem] bg-orange-50/50 border border-orange-100 relative overflow-hidden group">
            ...
            <p className="text-[11px] font-bold text-slate-900 leading-tight">
              All nodes operational <br /> in Kolkata region.
            </p>
          </div>
        </nav>
