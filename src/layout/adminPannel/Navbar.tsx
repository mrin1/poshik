...
export default function Navbar() {
  ...
  if (!mounted)
    return <div className="h-20 bg-white border-b border-slate-50" />;
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="hidden sm:block">
            <span className="text-sm font-black uppercase tracking-[0.2em] text-slate-400 block leading-none mb-1">
              Poshik
            </span>
            <span className="text-lg font-[900] uppercase tracking-tighter text-slate-900 leading-none">
              Control Center
            </span>
          </div>
        </div>
