              ...
              >
                ...
                <div className="flex-1 text-left overflow-hidden">
                  <div className="flex justify-between items-center mb-1">
                    <span className="font-black text-slate-900 uppercase text-xs truncate mr-2">
                      {conv.ownerName}
                    </span>
                  ...
                  <div className="text-[10px] font-black text-blue-600 uppercase truncate">
                    {conv.petName}
                  </div>
                  <p
                    className={`text-[11px] font-bold truncate ${conv.unread > 0 ? "text-slate-900" : "text-slate-400"}`}
                  >
                    {conv.lastMessage}
                  </p>
                </div>
                {conv.unread > 0 && (
                  <span className="bg-orange-600 text-white text-[9px] font-black h-5 w-5 flex items-center justify-center rounded-full shrink-0">
                    {conv.unread}
                  </span>
                )}
              </button>
