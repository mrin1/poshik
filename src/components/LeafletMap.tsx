        ...
        >
          <Popup className="rounded-2xl">
            <div className="font-sans p-1 text-center">
              <h3 className="font-[900] uppercase text-slate-900 text-sm tracking-tighter m-0">
                {item.title}
              </h3>
              <p className="text-[9px] font-bold text-slate-400 uppercase tracking-widest mt-1 mb-2">
